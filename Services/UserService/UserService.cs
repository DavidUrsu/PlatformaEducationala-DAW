...
namespace PlatformaEducationala_DAW.Services.UserService
{
	public class UserService : IUserService
	{
		...
		public IEnumerable<Course> GetCoursesWhereUserIsEnrolled(int id)
		{
			// get the courses where the user is enrolled
			return _courseRepository.GetEnrolledCoursesById(id).ToList();
		}
		...
		{
			// get the courses where the user is enrolled
			var courses = _courseRepository.GetEnrolledCoursesById(id);
